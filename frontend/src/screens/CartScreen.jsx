...
const CartScreen = () => {
    ...
    const checkoutHandler = () => {
        // if logged in goes to shipping else login page or screen 
                        ...
                        <Row>
                            ...
                            <Col md={2}>
                                <Button 
                                    type="button" 
                                    variant="light" 
                                    onClick={() => removeFromCartHandler(item._id)}><FaTrash/>
                                </Button>
                            </Col>
                    ...
                    <ListGroup variant="flush">
                        ...
                        <ListGroup.Item>
                            <Button 
                                ...
                                disabled={cartItems.length === 0 }> <FaCartPlus/> Proceed To Checkout</Button>
                        </ListGroup.Item>
                    </ListGroup>
                </Card>
            </Col>
